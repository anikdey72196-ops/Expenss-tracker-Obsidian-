...
def _call_groq(messages, stream=False, max_tokens=256, timeout=30):
...
def insights():
    ...
    try:
        ...
        try:
            ...
            tip_response = _call_llm_single(tip_messages, max_tokens=150, timeout=15)
